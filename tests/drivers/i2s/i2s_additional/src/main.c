...
#elif !defined(I2S_TEST_DATA_FORMAT_LEFT_JUSTIFIED_UNSUPPORTED)
	.format = I2S_FMT_DATA_FORMAT_LEFT_JUSTIFIED,
#elif !defined(I2S_TEST_DATA_FORMAT_RIGHT_JUSTIFIED_UNSUPPORTED)
	.format = I2S_FMT_DATA_FORMAT_RIGHT_JUSTIFIED,
#elif !defined(I2S_TEST_DATA_FORMAT_PCM_LONG_UNSUPPORTED)
	.format = I2S_FMT_DATA_FORMAT_PCM_LONG,
#elif !defined(I2S_TEST_DATA_FORMAT_PCM_SHORT_UNSUPPORTED)
	.format = I2S_FMT_DATA_FORMAT_PCM_SHORT,
#else
